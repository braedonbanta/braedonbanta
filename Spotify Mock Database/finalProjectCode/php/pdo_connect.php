...
const DBCONNSTRING ='mysql:host=localhost;dbname=CSC455SP24Yellow'; // prev. dbname 'glv5151'
const DB_USER = 'glv5151';
const DB_PASSWORD = '1HateCo11ege'; // if doesn't work try '1HateCo11ege,' with the comma
